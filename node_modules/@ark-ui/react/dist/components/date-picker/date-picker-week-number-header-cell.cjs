...
var DatePickerWeekNumberHeaderCell = (0, react.forwardRef)((props, ref) => {
	...
	const mergedProps = (0, _zag_js_react.mergeProps)(datePicker.getWeekNumberHeaderCellProps(tableProps), props);
