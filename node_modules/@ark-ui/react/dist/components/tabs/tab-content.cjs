...
var TabContent = (0, react.forwardRef)((props, ref) => {
	...
	const mergedProps = (0, _zag_js_react.mergeProps)(tabs.getContentProps(contentProps), presence.getPresenceProps(), localProps);
