...
__export(menu_dom_exports, {
  ...
  getContextTriggerEls: () => getContextTriggerEls,
  ...
  isTargetWithinMenuTree: () => isTargetWithinMenuTree,
...
var getTriggerEls = (ctx) => (0, import_dom_query.queryAll)(ctx.getDoc(), `[data-scope="menu"][data-part="trigger"][data-ownedby="${ctx.id}"]`);
var getContextTriggerEls = (ctx) => (0, import_dom_query.queryAll)(ctx.getDoc(), `[data-scope="menu"][data-part="context-trigger"][data-ownedby="${ctx.id}"]`);
...
function isTargetWithinMenuTree(target, children) {
  ...
  for (const id in children) {
    ...
    if (childContent && (0, import_dom_query.contains)(childContent, target)) return true;
