...
import { SwipeSession, PhysicalSwipeDirection } from './utils/session.mjs';
...
export { type ContentProps as C, type DrawerApi as D, type ElementIds as E, type OpenChangeDetails as O, type ResolvedSnapPoint as R, type SnapPoint as S, type TriggerProps as T, type DrawerStack as a, type DrawerStackApi as b, type DrawerStackSnapshot as c, type DrawerMachine as d, type DrawerProps as e, type DrawerService as f, type SnapPointChangeDetails as g, type SwipeAreaProps as h, type SwipeDirection as i, type TriggerValueChangeDetails as j, type DrawerSchema as k, DrawerSwipeSession as l, getSwipeDirectionSize as m, hasOpeningSwipeIntent as n, isTextSelectionInDrawer as o, oppositeSwipeDirection as p, resolveSwipeProgress as q, resolveSwipeDirection as r, shouldIgnorePointerDownForDrag as s };
