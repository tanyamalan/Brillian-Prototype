...
var DrawerSwipeSession = class {
  ...
  resolveSnapPointOnRelease(snapPoints, snapPoint, snapToSequentialPoints, contentSize) {
    ...
    return (0, import_snap_point.findClosestSnapPoint)(targetOffset, snapPoints).value;
  }
