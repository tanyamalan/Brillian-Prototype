...
var snap_point_exports = {};
__export(snap_point_exports, {
  dedupeSnapPoints: () => dedupeSnapPoints,
  findClosestSnapPoint: () => findClosestSnapPoint,
  resolveSnapPoint: () => resolveSnapPoint
});
module.exports = __toCommonJS(snap_point_exports);
...
function resolveSnapPointValue(snapPoint, viewportSize, rootFontSize) {
  ...
  if (typeof snapPoint === "number") {
    ...
    if (snapPoint <= 1) return (0, import_utils.clampValue)(snapPoint, 0, 1) * viewportSize;
    return snapPoint;
  }
...
function resolveSnapPoint(snapPoint, options) {
  ...
  const height = (0, import_utils.clampValue)(resolvedSize, 0, maxSize);
  return {
    value: snapPoint,
    height,
