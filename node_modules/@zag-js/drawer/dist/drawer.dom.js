...
__export(drawer_dom_exports, {
  ...
  getSwipeAreaEl: () => getSwipeAreaEl,
  getSwipeAreaId: () => getSwipeAreaId,
  getTitleEl: () => getTitleEl,
  getTitleId: () => getTitleId,
  getTriggerEl: () => getTriggerEl,
  getTriggerEls: () => getTriggerEls,
  getTriggerId: () => getTriggerId,
  isPointerWithinContentOrSwipeArea: () => isPointerWithinContentOrSwipeArea
});
...
var getTriggerEls = (ctx) => (0, import_dom_query.queryAll)(ctx.getDoc(), `[data-scope="drawer"][data-part="trigger"][data-ownedby="${ctx.id}"]`);
...
function isPointerWithinContentOrSwipeArea(target, content, swipeArea) {
...
0 && (module.exports = {
  ...
  getTriggerEls,
  getTriggerId,
  isPointerWithinContentOrSwipeArea
});
