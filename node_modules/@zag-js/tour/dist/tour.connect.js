    ...
    getBackdropProps() {
      return normalize.element({
        ...
        style: {
          ...
          position: (0, import_step.isDialogStep)(step) ? "fixed" : "absolute",
          inset: "0",
          willChange: (0, import_step.isTooltipStep)(step) ? "clip-path" : void 0
        }
      });
    },
    getSpotlightProps() {
      return normalize.element({
        ...
        style: {
          "--tour-layer": 1,
          position: "absolute",
          width: (0, import_utils.toPx)(targetRect.width),
          height: (0, import_utils.toPx)(targetRect.height),
          left: (0, import_utils.toPx)(targetRect.x),
          top: (0, import_utils.toPx)(targetRect.y),
          borderRadius: (0, import_utils.toPx)(prop("spotlightRadius")),
          pointerEvents: "none"
        }
      });
    },
