import { Calendar, AnyDateTime, DateValue, DateFormatter, CalendarIdentifier } from '@internationalized/date';
...
declare function resolvedHourCycle(formatter: DateFormatter): HourCycle$1;
declare function incompleteDateHash(dv: IncompleteDate): string;
declare function incompleteDateEqual(a: IncompleteDate, b: IncompleteDate): boolean;
declare function initDisplayValues(value: DateValue[] | undefined, placeholderValue: DateValue, hourCycle: HourCycle$1, count: number): IncompleteDate[];
/**
...
declare class IncompleteDate {
    ...
    offset: number | null;
    constructor(calendar: Calendar, hourCycle: HourCycle$1, dateValue?: Partial<Omit<AnyDateTime, "copy">> | null);
    copy(): IncompleteDate;
...
declare function toHourCycle(hour: number, hourCycle: HourCycle$1): [number | null, number];

declare function needsTimeGranularity(granularity: DateGranularity): boolean;
declare function getFormatterOptions(granularity: DateGranularity, digitStyle: "2-digit" | "numeric", hourCycle: "h12" | "h23" | undefined, timeZone: string): Intl.DateTimeFormatOptions;
declare function resolveAllSegments(formatter: DateFormatter): Segments;
...
declare const PAGE_STEP: {
    ...
    readonly minute: 15;
    readonly second: 15;
    readonly dayPeriod: undefined;
    readonly era: undefined;
    readonly literal: undefined;
    readonly timeZoneName: undefined;
    readonly weekday: undefined;
    readonly unknown: undefined;
    readonly fractionalSecond: undefined;
};
declare function getSegmentLabel(type: string): string;
declare const TYPE_MAPPING: {
    readonly dayperiod: "dayPeriod";
    readonly relatedYear: "year";
    readonly yearName: "literal";
    readonly unknown: "literal";
};
...
declare function processSegments({ dateValue, displayValue, formatter, locale, translations, granularity, }: ProcessSegmentsProps): DateSegment[];
...
export { processSegments as A, resolveAllSegments as B, type DateInputApi as D, type EditableSegmentType as E, type FocusChangeDetails as F, type HiddenInputProps as H, type IntlTranslations as I, type LabelProps as L, type PlaceholderChangeDetails as P, type SegmentGroupProps as S, TYPE_MAPPING as T, type ValueChangeDetails as V, type DateSegment as a, type ElementIds as b, type FormatDateDetails as c, type HourCycle as d, type DateInputMachine as e, type DateInputProps as f, type SegmentProps as g, type SegmentState as h, type SegmentType as i, type Segments as j, type SegmentsProps as k, type SelectionMode as l, type DateInputService as m, type DateInputSchema as n, IncompleteDate as o, type HourCycle$1 as p, incompleteDateEqual as q, incompleteDateHash as r, initDisplayValues as s, resolvedHourCycle as t, toHourCycle as u, EDITABLE_SEGMENTS as v, PAGE_STEP as w, getFormatterOptions as x, getSegmentLabel as y, needsTimeGranularity as z };
