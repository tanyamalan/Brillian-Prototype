...
var date_input_connect_exports = {};
__export(date_input_connect_exports, {
  connect: () => connect
});
module.exports = __toCommonJS(date_input_connect_exports);
var import_dom_query = require("@zag-js/dom-query");
var import_date_input = require("./date-input.anatomy.js");
var dom = __toESM(require("./date-input.dom.js"));
var import_locale = require("./utils/locale.js");
...
function connect(service, normalize) {
  ...
  const separator = (0, import_locale.getLocaleSeparator)(locale);
  ...
  return {
    ...
    getSegments(props = {}) {
      ...
      if (focused && enteredKeys && index === activeIndex && activeSegmentIndex >= 0) {
        const localActiveSegmentIndex = activeSegmentIndex - (0, import_validity.getGroupOffset)(allSegments, index);
    ...
    getRootProps() {
      return normalize.element({
        ...import_date_input.parts.root.attrs,
        dir: prop("dir"),
    ...
    getLabelProps(props = {}) {
      ...
      return normalize.label({
        ...import_date_input.parts.label.attrs,
    ...
    getControlProps() {
      return normalize.element({
        ...import_date_input.parts.control.attrs,
        dir: prop("dir"),
    ...
    getSegmentGroupProps(props = {}) {
      ...
      const activeIndex = context.get("activeIndex");
      return normalize.element({
        ...import_date_input.parts.segmentGroup.attrs,
        ...
        "data-readonly": (0, import_dom_query.dataAttr)(readOnly),
        "data-invalid": (0, import_dom_query.dataAttr)(invalid),
        "data-focus": (0, import_dom_query.dataAttr)(focused && activeIndex === index),
        style: {
          unicodeBidi: "isolate"
        }
      });
    ...
    getSegmentProps(props) {
      ...
      if (segment.type === "literal") {
        return normalize.element({
          ...import_date_input.parts.segment.attrs,
          dir: prop("dir"),
          "aria-hidden": true,
      ...
      return normalize.element({
        ...
        enterKeyHint: "next",
        "aria-label": (0, import_segments.getSegmentLabel)(segment.type),
        ...
        "aria-readonly": (0, import_dom_query.ariaAttr)(segmentState.readonly),
        "aria-disabled": (0, import_dom_query.ariaAttr)(disabled),
        "data-value": segment.value,
        "data-type": segment.type,
        "data-readonly": (0, import_dom_query.dataAttr)(segmentState.readonly),
        "data-disabled": (0, import_dom_query.dataAttr)(disabled),
        "data-editable": (0, import_dom_query.dataAttr)(segment.isEditable && !readOnly && !disabled),
        "data-placeholder-shown": (0, import_dom_query.dataAttr)(segment.isPlaceholder),
        style: {
        ...
        onKeyDown(event) {
          if (event.defaultPrevented || event.ctrlKey || event.metaKey || event.shiftKey || event.altKey || readOnly || (0, import_dom_query.isComposingEvent)(event)) {
            return;
          }
          const keyMap = {
            ArrowLeft() {
            ...
            PageUp() {
              send({
                type: "SEGMENT.ADJUST",
                segment,
                amount: import_segments.PAGE_STEP[segment.type] ?? 1
              });
            },
            PageDown() {
              send({
        ...
        onBeforeInput(event) {
          const { data, inputType } = (0, import_dom_query.getNativeEvent)(event);
          ...
          if (data && (isTextSegment || (0, import_locale.isValidCharacter)(data, separator))) {
            event.preventDefault();
            send({ type: "SEGMENT.INPUT", segment, input: data });
          } else {
            event.preventDefault();
    ...
    getHiddenInputProps(props = {}) {
      ...
      return normalize.input({
        ...import_date_input.parts.hiddenInput.attrs,
        type: "hidden",
