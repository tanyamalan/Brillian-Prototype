  ...
  switch (type) {
    case "dayPeriod": {
      ...
      if (am.toLowerCase().startsWith(lowerInput)) {
        (0, import_validity.setDisplayValue)(ctx, index, dv.set("dayPeriod", 0, placeholderValue));
      } else if (pm.toLowerCase().startsWith(lowerInput)) {
        (0, import_validity.setDisplayValue)(ctx, index, dv.set("dayPeriod", 12, placeholderValue));
      } else {
        break;
      }
      (0, import_validity.advanceToNextSegment)(ctx);
      break;
    }
    case "era": {
      ...
      for (let i = 0; i < eras.length; i++) {
        ...
        if (formattedEra && formattedEra.toLowerCase().startsWith(lowerInput)) {
          (0, import_validity.setDisplayValue)(ctx, index, dv.set("era", eras[i], placeholderValue));
          (0, import_validity.advanceToNextSegment)(ctx);
          break;
        }
      }
